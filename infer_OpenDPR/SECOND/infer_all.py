...
OUTPUT_DIR = "output/SECOND/infer_all"
NUM_CLASSES = 6
...
file_names = sorted(
    os.listdir(os.path.join(INPUT_DIR, "im1")),
    key=natural_sort_key,
)
for file_name in tqdm(file_names, desc="Processing", unit="iteration"):
    ...
    change_dir = os.path.join(all_output_dir, "Change")
    ...
    imsave(os.path.join(change_dir, file_name), (change_mask / 255).astype(np.uint8))
