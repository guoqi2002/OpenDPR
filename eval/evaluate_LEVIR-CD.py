...
def main():
    ...
    parser.add_argument("--pred", type=str, default="output/LEVIR/infer_building", help="Prediction directory path")
    parser.add_argument("--gt", type=str, default="<LEVIR_CD_ROOT>/test/label/", help="Ground truth labels directory")
