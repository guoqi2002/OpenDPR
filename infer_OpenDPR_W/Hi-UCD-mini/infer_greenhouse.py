...
def load_change_location_label(file_name, shape):
    ...
    if label.shape != shape:
        label = resize(label, shape, order=0, preserve_range=True, anti_aliasing=False).astype(label.dtype)
...
FOREGROUND_CLASS = "greenhouse"

INPUT_DIR = "<HIUCD_ROOT>/test/image/"
OUTPUT_DIR = "output/HIUCD/infer_greenhouse"
CHANGE_LABEL_DIR = "S2C_results/Hi-UCD"
